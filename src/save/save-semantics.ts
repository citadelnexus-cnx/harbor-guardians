...
import type { SchemaValidationErrorObject } from "./generated/save-blob-schema-validator.mjs";
...
/** A validator that narrows an unknown value to a SaveBlob, throwing on any violation. */
...
function formatSchemaErrors(errors: SchemaValidationErrorObject[] | null | undefined): string {
 ...
 */
export function assertSaveBlobValid(blob: unknown): asserts blob is SaveBlob {
